...
module.exports = function () {
    ...
    app.user(bodyParser.raw({type: 'image/jpeg', limit: '200mb'}))
    app.user(bodyParser.raw({type: 'image/png', limit: '200mb'}))
    app.user(bodyParser.raw({type: 'image/gif', limit: '200mb'}))
